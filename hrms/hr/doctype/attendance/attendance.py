...
class Attendance(Document):
	def validate(self):
		...
		validate_status(self.status, ["Present", "Absent", "On Leave", "Half Day", "Work From Home", "Weekly Off", "Day Off", "PH or Comp Off", "Night Off", "Annual Leave", "Unpaid Leave", "Sick Leave"])
